-- Complete Database Schema for Investment Platform with Admin Panel
-- COMPLETELY REMOVED updated_at column to avoid Supabase trigger issues
...
-- Note: In production, you should use a stronger password and hash it properly
-- The password below is for development purposes only
